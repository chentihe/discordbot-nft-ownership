...
const headDaoStakingAddress = "0xfc01a9C57f793F9Ce4A1F4BD678Ddeab14c3e130";

const headDaoStakingAbi = [
  {
    inputs: [
      {
...
const headDaoContract = new ethers.Contract(
  headDaoStakingAddress,
  headDaoStakingAbi,
  provider
);

const HeadDaoStaker = (addr) => {
    return headDaoContract.depositsOf(addr);
}

export default HeadDaoStaker;